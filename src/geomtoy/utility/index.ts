...
const util = {
    ...
    isStringKeyOf<T extends object>(v: string, object: T): v is keyof T & string {
        return v in object;
    },
    ...
    isEqualTo(value: any, otherValue: any) {
        if (value === otherValue) return true;

        if (util.isString(value) || util.isBoolean(value) || util.isNumber(value)) {
