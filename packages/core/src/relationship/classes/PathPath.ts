...
// export default class PathPath extends BaseRelationship {
//     constructor(owner: Geomtoy, public geometry1: Path, public geometry2: Path) {
//         super(owner);
//         const [dg1, allowed1] = geometry1.degeneration();
//         const [dg2, allowed2] = geometry2.degeneration();
...
//                     relationship: new LineSegmentLineSegment(owner, seg1, seg2),
//                     index1,
//                     index2
//                 });
//             });
...
//                 return acc;
//             }, [] as [number, number][])
//         ).map(c => new Point(this.owner, c));
//     }

//     @cached
//     private _mixPredicate() {
//         const epsilon = this.options_.epsilon;
//         const ei = new EndpointIntersection(this.owner);
...
//     @superPreprocess("handleDegeneration")
//     strike() {
//         return this._mixPredicate().strike.map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     contact() {
//         return this._mixPredicate().contact.map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     cross() {
//         return this._mixPredicate().cross.map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     touch() {
//         return this._mixPredicate().touch.map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     block() {
...
//             return acc;
//         }, [] as [number, number][]);
//         return [...firstBlock, ...lastBlock].map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     blockedBy() {
...
//             return acc;
//         }, [] as [number, number][]);
//         return [...firstBlockedBy, ...lastBlockedBy].map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     connect() {
...
//             return acc;
//         }, [] as [number, number][]);
//         return [...firstConnect, ...lastConnect].map(c => new Point(this.owner, c));
//     }
//     @superPreprocess("handleDegeneration")
//     coincide() {
