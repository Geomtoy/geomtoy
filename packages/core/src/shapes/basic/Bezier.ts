...
class Bezier extends Shape implements FiniteOpenShape, TransformableShape {
    ...
    private _setPoint1X(value: number) {
        if (!Utility.isEqualTo(this._point1X, value)) this.trigger_(EventObject.simple(this, Bezier.events.point1XChanged));
        this._point1X = value;
    }
    private _setPoint1Y(value: number) {
        if (!Utility.isEqualTo(this._point1Y, value)) this.trigger_(EventObject.simple(this, Bezier.events.point1YChanged));
        this._point1Y = value;
    }
    private _setPoint2X(value: number) {
        if (!Utility.isEqualTo(this._point2X, value)) this.trigger_(EventObject.simple(this, Bezier.events.point2XChanged));
        this._point2X = value;
    }
    private _setPoint2Y(value: number) {
        if (!Utility.isEqualTo(this._point2Y, value)) this.trigger_(EventObject.simple(this, Bezier.events.point2YChanged));
        this._point2Y = value;
    }
    private _setControlPoint1X(value: number) {
        if (!Utility.isEqualTo(this._controlPoint1X, value)) this.trigger_(EventObject.simple(this, Bezier.events.controlPoint1XChanged));
        this._controlPoint1X = value;
    }
    private _setControlPoint1Y(value: number) {
        if (!Utility.isEqualTo(this._controlPoint1Y, value)) this.trigger_(EventObject.simple(this, Bezier.events.controlPoint1YChanged));
        this._controlPoint1Y = value;
    }
    private _setControlPoint2X(value: number) {
        if (!Utility.isEqualTo(this._controlPoint2X, value)) this.trigger_(EventObject.simple(this, Bezier.events.controlPoint2XChanged));
        this._controlPoint2X = value;
    }
    private _setControlPoint2Y(value: number) {
        if (!Utility.isEqualTo(this._controlPoint2Y, value)) this.trigger_(EventObject.simple(this, Bezier.events.controlPoint2YChanged));
    ...
    isValid() {
        ...
        if (!Coordinates.isValid(cpc1)) return false;
        if (!Coordinates.isValid(cpc2)) return false;
    ...
    isSameAs2(bezier: Bezier) {
        const epsilon = this.options_.epsilon;
        return (
            Coordinates.isEqualTo(this.point1Coordinates, bezier.point1Coordinates, epsilon) &&
            Coordinates.isEqualTo(this.point2Coordinates, bezier.point2Coordinates, epsilon) &&
            Coordinates.isEqualTo(this.controlPoint1Coordinates, bezier.controlPoint1Coordinates, epsilon) &&
            Coordinates.isEqualTo(this.controlPoint2Coordinates, bezier.controlPoint2Coordinates, epsilon)
        );
    }
