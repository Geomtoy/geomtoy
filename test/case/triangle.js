...
let gui = new dat.GUI(),
    points = {
        ...
        point2: { object: G.Point(0, 25), controller: { x: undefined, y: undefined } },
        point3: { object: G.Point(35, -16), controller: { x: undefined, y: undefined } }
    },
    setting = {
        sideLines: true,
        medianSegments: true,
...
let currentTouch = null,
    dragging = false,
    touchable = [
        { object: points.point1.object, path2D: undefined },
        { object: points.point2.object, path2D: undefined },
        { object: points.point3.object, path2D: undefined }
    ]
...
function draw() {
    ...
    Object.assign(tri, { point1: p1, point2: p2, point3: p3 })
